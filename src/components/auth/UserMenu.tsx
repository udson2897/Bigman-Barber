...
const UserMenu = ({ user, onLogout }: UserMenuProps) => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-slate-200 dark:border-slate-700 py-2 z-[9999]">
          {/* User Info */}
          ...
          <div className="py-2">
            ...
            <button
              ...
              className="w-full flex items-center space-x-3 px-4 py-2 text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
            >
